...
export const experience = [
  ...
  },
  {
    ...
    location: "Remote, UK",
    points: [
      "Sober Meets: Developed and deployed an AI-driven predictive match-analysis system — improved match accuracy by 35% and user engagement by 20% in three months by integrating real-time feedback loops using LangChain and Pinecone.",
      "ZORQK: Built a conversational AI car-discovery chatbot that parses natural-language queries into structured search filters using LangChain, improving search relevance for non-technical users.",
    ],
    stack: ["LangChain", "Pinecone", "Conversational AI", "Python"],
  },
  {
    ...
    points: [
      "Built an AI-driven time-tracking and billing platform (admin dashboard, mobile, and desktop), boosting accuracy by 25%.",
    ],
    stack: [
      "MongoDB",
      "Express",
